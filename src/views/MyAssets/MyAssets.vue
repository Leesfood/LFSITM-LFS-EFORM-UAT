		...
		<form @submit.prevent="submitForm">
			...
			<div class="  p-4 md:p-6 lg:p-10   ">
				...
				<div @click="toggleSection"
					...
					<span>
						<i :class="showSection ? 'fas fa-minus text-gray-600' : 'fas fa-plus text-gray-600'"
							class="circle-icon"></i>
					</span>
				...
				<div
					...
					<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
						...
						<div>
							<label for="gender" class="pt-2 text-[16px]">Request Type / <span
									class="battambang-regular text-[16px]">ប្រភេទការសុំ</span></label>
							<n-select v-model:value="form.requestType" :options="requestType" class="mt-3" />
						</div>
					</div>
...
const requestType = ref([
	...
	{ label: 'RequestChange', value: 'RequestChange' },
	{ label: 'RequestEmail', value: 'Req' },
