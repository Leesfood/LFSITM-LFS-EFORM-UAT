			...
			<div class="  p-4 md:p-6 lg:p-10   ">
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
						...
						<label for="leave-desinationlocation">Desination location / <span
								class="battambang-regular pt-2 text-[16px]">គោលដៅត្រូវទៅ</span><span class="text-red-800">**</span></label>
					...
					<div>
						<label for="reason-for-leave" class="pt-2 text-[16px] ">Purpose of Requested / <span
								class="battambang-regular text-[16px]">គោលបំណងនៃការស្នើសុំ</span><span class="text-red-800">**</span></label>
