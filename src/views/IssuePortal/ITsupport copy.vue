      ...
      <span class="pl-2">Request information detail</span>
		  ...
		  <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
            ...
            <label for="gender" class="pt-2 text-[16px]">Issue Type / <span
                class="battambang-regular text-[16px]">ប្រភេទបញ្ហា</span></label>
          ...
          <div>
            <label for="gender" class="pt-2 text-[16px]">Priority / <span
                class="battambang-regular text-[16px]">អាទិភាព</span></label>
...
<div>
  ...
  const form = ref({
	...
	RequestTitleEN: "Create Issue Support",
	RequestTitleKH: "ស្នើរសុំជំនួយពី IT",
	LeaveType: "ស្នើរសុំជំនួយពី/Issue Support",
	EmployeeID: "",
	EmployeeName: "",
	Site: "",
	Department: "",
