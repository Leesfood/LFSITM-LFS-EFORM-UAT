            ...
            <div v-if="employee" class="flex flex-col">
                ...
                <div class="sm:w-[80%] xs:w-[90%] mx-auto flex">
                    <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="User Profile"
                        class="rounded-md lg:w-[10rem] my-5 lg:h-[10rem] md:w-[10rem] md:h-[10rem] sm:w-[8rem] sm:h-[8rem] xs:w-[7rem] xs:h-[7rem] lg:bottom-[5rem] sm:bottom-[4rem] xs:bottom-[3rem]" />

                    <!-- FullName -->
                    <h1
                        class="w-full text-left my-20 sm:mx-4 xs:pl-4 text-gray-800 dark:text-white lg:text-4xl md:text-3xl sm:text-3xl xs:text-xl font-serif">
                        {{ employee.employeename || 'Not available' }}</h1>
                    <div class="flex justify-center mt-20">
                        <router-link :to="{ name: 'edit-Employee', params: { id: employee.employeeid } }">
                            <button
                                class=" flex px-5 py-3 bg-red-600 text-white text-lg font-semibold rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div
                    class="xl:w-[80%] lg:w-[90%] md:w-[90%] sm:w-[92%] xs:w-[90%] mx-auto flex flex-col gap-4 items-center lg:-top-8 md:-top-6 sm:-top-4 xs:-top-4">
                    <!-- Detail -->
                            ...
                            <div class="w-full">
                                <div
                                    ...
                                    <div class="flex flex-col pb-3">
                                        ...
                                        <p class="text-lg font-semibold">{{ employee.employeeid || 'Not available' }}
                                        </p>
                                    </div>
                                    <div class="flex flex-col pb-3">
                                    ...
                                    <div class="flex flex-col pb-3">
                                        ...
                                        <p class="text-lg font-semibold">{{ employee.department || 'Not available' }}
                                        </p>
                                    </div>
                                    <div class="flex flex-col pb-3">
                                    ...
                                    <div class="flex flex-col pt-3">
                                        ...
                                        <p class="text-lg font-semibold hover:text-blue-500">{{ employee.emailapproverl2
                                            || 'Not available' }}</p>
                                    </div>
                                    <div class="flex flex-col pt-3">
                                        <p class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Approver Email 3</p>
                                        <p class="text-lg font-semibold hover:text-blue-500">{{ employee.emailapproverl3
                                            || 'Not available' }}</p>
                                    </div>
                                    <div class="flex flex-col pt-3">
                                        <p class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Status</p>
                                        <p :class="{ 'text-green-500': employee.status === 'Active', 'text-red-500': employee.status === 'Inactive' }"
                            ...
                            <div class="w-full">
                                <div
                                    ...
                                    <div class="flex flex-col pb-3">
                                        ...
                                        <p class="text-lg font-semibold">{{ employee.employeename || 'Not available' }}
                                        </p>
                                    </div>
                                    <div class="flex flex-col pt-3">
                                    ...
                                    <div class="flex flex-col pt-3">
                                        ...
                                        <p class="text-lg hover:text-blue-500 font-semibold">{{ employee.emailapproverl1
                                            || 'Not available' }}</p>
                                    </div>
                                    <div class="flex flex-col pt-3">
                                        <p class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Acknowledge Email
                                        </p>
                                        <p class="text-lg font-semibold">{{ employee.acknowledgeby || 'Not available' }}
                                        </p>
                                    </div>
                                    <div class="flex flex-col pt-3">
                                        <p class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Allow Date</p>
                                        <p class="text-lg font-semibold hover:text-blue-500">{{ employee.allowdate ||
                                            'Not available' }} </p>
                                    </div>
                                </div>
                            </div>
