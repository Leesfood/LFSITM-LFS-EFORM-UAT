...
<template>
  <div class="flex">
    ...
    <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-red-700 lg:translate-x-0 lg:static lg:inset-0">
      ...
      <nav class="mt-10">
        <router-link v-if="allowedRoutes.dashboard" class="flex text-white items-center px-6 py-2 mt-4 duration-200 border-l-4"
        ...
        <router-link v-if="allowedRoutes.employee" class="flex items-center text-white px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4">Employees List</span>
        </router-link>

       

        <router-link v-if="allowedRoutes.forms" class="flex items-center text-white px-6 py-2 mt-4 duration-200 border-l-4"
        ...
        <router-link v-if="allowedRoutes.cards" class="flex items-center text-white px-6 py-2 mt-4 duration-200 border-l-4"
        ...
        <router-link v-if="allowedRoutes.modal" class="flex items-center text-white px-6 py-2 mt-4 duration-200 border-l-4"
        ...
        <router-link v-if="allowedRoutes.blank" class="flex items-center text-white px-6 py-2 mt-4 duration-200 border-l-4"
