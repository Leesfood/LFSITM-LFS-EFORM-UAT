    ...
    <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <nav class="mt-10">
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4 text-white">Employees List</span>
        </router-link>
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4 text-white">UI Elements</span>
        </router-link>
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4 text-white">Forms</span>
        </router-link>
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4 text-white">Cards</span>
        </router-link>
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4 text-white">Modal</span>
        </router-link>
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4 text-white">Blank</span>
        </router-link>
      </nav>
    </div>
  </div>
