...
const form = ref({
	...
	BackDate: null,
	BackTime: null,
	RequestTitleEN: "Maternity Leave form",
	RequestTitleKH: "ពាក្យសុំច្បាប់ឈប់សម្រាកមាតុភាព",
	LeaveType: "សម្រាកមាតុភាព/ Maternity Leave",
	EmployeeID: "",
	EmployeeName: "",
	Site: "",
	Department: "",
...
const NumberOfDayrequested = ref([
	...
	{ label: '10 ថ្ងៃ/Day', value: '10' },
	{ label: '20 ថ្ងៃ/Day', value: '20' },
	{ label: '30 ថ្ងៃ/Day', value: '30' },
...
const submitForm = async () => {
	...
	const confirmMessage = `
		...
		<p class="p-custom"><span class="custom-width">Line Manager:</span><span class="custom-span">${form.value.EmailApprover}</span></p>
